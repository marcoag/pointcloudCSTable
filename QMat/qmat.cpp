...
{
	Q_ASSERT_X(canAllocateRotationMatrix(),"QMat::extractAngles", "Invalid matrix size in QMAt::extractAngles");

	QVec v(3);
    
	v(0) = atan2f( -this->operator()(1,2),this->operator()(2,2));
	v(1) = asin( this->operator()(0,2));
	v(2) = atan2f( -this->operator()(0,1),this->operator()(0,0));
